...
jsonApi.define = resourceConfig => {
  ...
  resourceConfig.searchParams = _.assign({
    ...
    fields: ourJoi.Joi.any()
      .description('A collection+fieldname to include')
      .example('title'),
    include: ourJoi.Joi.any()
      .description('A relation to include')
      .example('title'),
    includeDeleted: ourJoi.Joi.boolean(false)
      .description('Include documents flagged as deleted')
